...
// use crate::common::{ meta::Metadata, cache::CacheUpdater };


// pub struct UnixStore {
//     index: usize,
//     state: Metadata,
//     stash: Vec<Metadata>,
// }
...
// impl TerminalCursor for UnixStore {
...
// impl TerminalModifier for UnixStore {
//     fn raw(&mut self) {
...
// impl TerminalFormatter for UnixStore {
...
// impl TerminalWriter for UnixStore {
...
// impl TerminalInput for UnixStore {
//     fn read_char() -> char {
...
// impl TerminalSwitcher for UnixStore {
//     fn switch(&mut self) {
